    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $url;?>validasi-edit-profil-civitas"><?php echo $navbar;?></a>
            </div>
            <!-- /.navbar-header -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" form action="<?php echo $url;?>validasi-edit-profil-civitas" method="post">                        
                                            <input id="id" name="id" value="<?php echo $validasi->value('id');?>" type="text" class="form-control" hidden>
                                            
                                            <div class="form-group">
                                             <p><?php echo $validasi->errorMessages('name', '<p style="color:red">', '</p>');?></p>
                                                <label>Nama Lengkap</label>
                                                <input id="name" name="name" value="<?php echo $validasi->value('name');?>" type="text" class="form-control" placeholder="Nama">
                                            </div>

                                            <div class="form-group">
                                            <p><?php echo $validasi->errorMessages('email', '<p style="color:red">', '</p>');?></p>
                                                <label>Email</label>
                                                <input id="email" name="email" value="<?php echo $validasi->value('email');?>" type="text" class="form-control" placeholder="Email">
                                            </div>

                                            <div class="form-group">
                                            <p><?php echo $validasi->errorMessages('phone', '<p style="color:red">', '</p>');?></p>
                                                <label>Nomor HP</label>
                                                <input id="phone" name="phone" value="<?php echo $validasi->value('phone');?>" type="text" class="form-control" placeholder="Nomor HP">
                                            </div>
                                            
                                            <div class="form-group">
                                            <p><?php echo $validasi->errorMessages('address', '<p style="color:red">', '</p>');?></p>
                                                <label>Alamat</label>
                                                <input id="address" name="address" value="<?php echo $validasi->value('address');?>" type="text" class="form-control" placeholder="Alamat">
                                            </div>
